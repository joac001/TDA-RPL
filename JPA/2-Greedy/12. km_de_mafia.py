...
"""
Es un algoritmo 2-Greedy porque va buscando soluciones locales óptimas a fin de obtener una global. En este caso,se pretende evaluar cada pedido según su kilómetro máximo solicitado. De manera ascendente, se van seleccionando los rangos de km de modo que no haya solapamientos. El resultado será una selección optimizada de la cantidad de pedidos.
