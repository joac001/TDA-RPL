def charlas(horarios):
    ...
    """
Es un algoritmo 2-Greedy porque va buscando soluciones locales óptimas a fin de obtener una global. En este caso,se pretende evaluar cada charla según su horario de finalizacióón. De manera ascendente, se van seleccionando las charlas de modo que no hayan solapamiento. El resultado será una selección optimizada de la cantidad de charlas.
