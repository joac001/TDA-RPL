...
aT(n/b)+O(nc) n elevado a la c
a = cantidad de llamados recursivos
En este caso tenemos 2 llamadas recursivas
b = proporción del tamaño original con el que se trabaja recursivamente
En este algoritmo la cantidad parcial de elementos se divide a la mitad por vez, de ahí que b = 2
c = costo de partir y juntar
El costo es lineal, por lo que c = 1.
Al calcular las sumas cruzadas, si suponemos el peor caso,se recorerrán los n elementos que conformen al subarreglo,por lo que O(nc) = O(n)
